...
public class TradeLockRuleFilterFactory {
    ...
    public BusinessLinkedList<TradeLockRuleCommandEntity, TradeLockRuleDynamicContext, TradeLockRuleFilterBackEntity> tradeRuleFilter(ActivityUsabilityRuleFilter activityUsabilityRuleFilter, UserTakeLimitRuleFilter userTakeLimitRuleFilter) {
        // 组装链
        LinkArmory<TradeLockRuleCommandEntity, TradeLockRuleDynamicContext, TradeLockRuleFilterBackEntity> linkArmory = new LinkArmory<>("tradeRuleFilter", activityUsabilityRuleFilter, userTakeLimitRuleFilter);
        // 链对象
